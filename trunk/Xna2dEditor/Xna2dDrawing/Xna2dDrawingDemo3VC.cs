...
namespace Fyri2dEditor
{
    ...
    {
        private XnaDrawingContext oldValue, newValue;
        ...
        public XnaDrawingContext OldContext
        {
            get
            {
                return oldValue;
        ...
        public XnaDrawingContext NewContext
        {
            get
            {
                return newValue;
    ...
    class Xna2dDrawingDemo3VC : GraphicsDeviceControl
    {
