...
{
    public class XnaDrawingContext : XnaDrawingBatch
    {
        ...
        #region Constructor
        public XnaDrawingContext(GraphicsDevice graphicsDevice)
            : base(graphicsDevice)
        {
            spriteBatch = new SpriteBatch(GraphicsDevice);
        }

        public XnaDrawingContext(RenderTarget2D renderTarget)
            : base(renderTarget)
        {
            spriteBatch = new SpriteBatch(GraphicsDevice);
        }

        public XnaDrawingContext(RenderTarget2D renderTarget, Texture2D background)
