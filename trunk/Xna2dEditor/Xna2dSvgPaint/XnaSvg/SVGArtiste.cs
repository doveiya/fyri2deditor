...
namespace Xna2dEditor
{
    ...
    public partial class SvgArtiste : Form
    {
        ...
        private void Intialize()
        {
            ...
            _infoFilesMain = _docker.Add(_svgMainFiles, zAllowedDock.Fill, new Guid("b6e1e171-d1e0-47cd-a683-5937b682cde9"));
            _infoFilesMain.ShowCloseButton = false;

            _infoToolbar = _docker.Add(_toolBox, zAllowedDock.All, new Guid("b6e1e171-d1e0-47cd-a683-5937b682cde9"));
            _infoToolbar.ShowCloseButton = false;

            _infoDocumentProperties = _docker.Add(_svgProperties, zAllowedDock.All, new Guid("b6e1e171-d1e0-47cd-a683-5937b682cde9"));
            ...
            _infoShapeProperties = _docker.Add(_shapeProperties, zAllowedDock.All, new Guid("b6e1e171-d1e0-47cd-a683-5937b682cde9"));
