...
namespace Fyri2dEditor
{
    ...
    /// </summary>
    public partial class BitmapFontExporter : Form
    {
        Bitmap globalBitmap;
        ...
        FyriProject theProject;

        /// <summary>
        /// Constructor.
        /// </summary>
        public BitmapFontExporter(FyriProject project)
        {
            InitializeComponent();
                ...
                if (fileSelector.ShowDialog() == DialogResult.OK)
                {
                    ...
                    try
                    {
                                                          ...
                                                          PixelFormat.Format32bppArgb))
                        {
                            ...
                            FontImageFileName = fileSelector.FileName;

                            // Save out the combined bitmap.
                            bitmap.Save(FontImageFileName, ImageFormat.Bmp);
                        }
                    }
                    finally
                    {
        ...
        public string FontImageFileName { get; set; }
    }
}
