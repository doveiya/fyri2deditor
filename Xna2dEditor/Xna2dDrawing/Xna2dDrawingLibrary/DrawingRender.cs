...
namespace Fyri2dEditor.Xna2dDrawingLibrary
{
    public class XnaDrawingRender
    {
        ...
        #region Constructor
        public XnaDrawingRender(GraphicsDevice graphicsDevice)
        {
            GraphicsDevice = graphicsDevice;
            this.Initialize();
        }

        public XnaDrawingRender(RenderTarget2D renderTarget)
        {
        ...
        public XnaDrawingRender(RenderTarget2D renderTarget, Texture2D background)
            : this(renderTarget)
        {
            this.RenderTarget = renderTarget;
            this.GraphicsDevice = renderTarget.GraphicsDevice;
