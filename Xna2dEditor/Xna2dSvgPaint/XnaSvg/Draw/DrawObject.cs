...
namespace Draw 
{
	...
	/// </summary>
	public abstract class XnaDrawObject : ICloneable
	{
		...
		public virtual Rectangle GetHandleRectangle(int handleNumber)
		{
			...
			return new Rectangle((int)point.X - 3, (int)point.Y - 3, 7, 7);
		}
		...
		public virtual string GetXmlStr(Point scale)
		{
			return "";
		}
        ...
        public virtual void Resize(Point newscale, Point oldscale) 
		{
		}

        public static Point RecalcPoint(Point pp, Point newscale, Point oldscale)
		{
            Point p = pp;
			p.X = p.X/oldscale.X;
			p.Y = p.Y/oldscale.Y;
        ...
        public void RecalcStrokeWidth(Point newscale, Point oldscale)
		{
			StrokeWidth = RecalcFloat(StrokeWidth, newscale.X,oldscale.Y);
		}
		...
		public static float ParseSize(string str, float dpi)
		{
			...
			{
				ErrH.Log("ParseFloat()", "XnaDrawObject", ex.ToString(), ErrH._LogPriority.Info);
				return 0;
			}
		}
