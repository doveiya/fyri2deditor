...
namespace Xna2dEditor.Tools.ToolBoxes
{
    public partial class ToolBox : Form
    {
        ...
        public void SetToolSelection(Fyri2dEditor.Xna2dDrawArea.Xna2dDrawToolType tool)
        {
            switch (tool)
            {
                case Fyri2dEditor.Xna2dDrawArea.Xna2dDrawToolType.Pointer:
                    radioButton_Pointer.Checked = true;
                    break;
                case Fyri2dEditor.Xna2dDrawArea.Xna2dDrawToolType.Ellipse:
                    radioButton_ellipse.Checked = true;
                    break;
                case Fyri2dEditor.Xna2dDrawArea.Xna2dDrawToolType.Rectangle:
                    radioButton_rectangle.Checked = true;
                    break;
                case Fyri2dEditor.Xna2dDrawArea.Xna2dDrawToolType.Line:
                    radioButton_line.Checked = true;
                    break;
                case Fyri2dEditor.Xna2dDrawArea.Xna2dDrawToolType.Pan:
                    radioButton_pan.Checked = true;
                    break;
                case Fyri2dEditor.Xna2dDrawArea.Xna2dDrawToolType.Polygon:
